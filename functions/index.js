...
exports.inizializza_db_utente = functions.auth.user().onCreate((user) => {
    ...
    let clienti_ref = db.collection('clienti').doc(user.uid)
    clienti_ref.set({})
...
/*exports.codice_fiscale = functions.https.onRequest((req, res) =>{
    return calcola('Gangemi','Lorenzo',true,new Date('1997-11-24'),'Cuneo')
});
...
function calcola (Cognome,Nome,Maschio,Data,Comune) {
    let risultato = ''
